...
export default function Dashboard() {
  ...
  const text = {
    th: {
      title: 'แดชบอร์ดพลังงานแสงอาทิตย์',
  ...
  const sampleData = [
    { id: 1, name: 'Huawei 10kW', power: 9.8, status: 'online', location: 'Chiang Mai' },
    { id: 2, name: 'Growatt 20kW', power: 18.4, status: 'offline', location: 'Khon Kaen' },
    { id: 3, name: 'SOLID 50kW', power: 48.9, status: 'online', location: 'Phuket' }
  ];
